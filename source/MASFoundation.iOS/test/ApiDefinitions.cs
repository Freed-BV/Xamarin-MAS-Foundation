...
namespace MASFoundation
{
	...
	partial interface Constants
	{
		...
		[Field ("MASNotStartedYet", "__Internal")]
		NSString MASNotStartedYet { get; }

		// extern NSString *const _Nonnull MASFileNameKey;
		[Field ("MASFileNameKey", "__Internal")]
		NSString MASFileNameKey { get; }

		// extern NSString *const _Nonnull MASOTPSuspensionTimeKey;
		[Field ("MASOTPSuspensionTimeKey", "__Internal")]
		NSString MASOTPSuspensionTimeKey { get; }

		// extern NSString *const _Nonnull MASResponseInfoHeaderInfoKey;
		[Field ("MASResponseInfoHeaderInfoKey", "__Internal")]
		NSString MASResponseInfoHeaderInfoKey { get; }

		// extern NSString *const _Nonnull MASNSHTTPURLResponseObjectKey;
		[Field ("MASNSHTTPURLResponseObjectKey", "__Internal")]
		NSString MASNSHTTPURLResponseObjectKey { get; }

		// extern NSString *const _Nonnull MASHeaderInfoErrorKey;
		[Field ("MASHeaderInfoErrorKey", "__Internal")]
		NSString MASHeaderInfoErrorKey { get; }

		// extern NSString *const _Nonnull MASResponseInfoBodyInfoKey;
		[Field ("MASResponseInfoBodyInfoKey", "__Internal")]
		NSString MASResponseInfoBodyInfoKey { get; }

		// extern NSString *const _Nonnull MASGatewayMonitorStatusKey;
		[Field ("MASGatewayMonitorStatusKey", "__Internal")]
		NSString MASGatewayMonitorStatusKey { get; }
	}
	...
	// typedef void (^MASDataTaskBlock)(MASDataTask * _Nullable);
	delegate void MASDataTaskBlock ([NullAllowed] MASDataTask arg0);
	...
	delegate void MASAuthCredentialsBlock ([NullAllowed] MASAuthCredentials arg0, bool arg1, [NullAllowed] MASCompletionErrorBlock arg2);

	// typedef void (^MASUserAuthCredentialsBlock)(MASAuthCredentialsBlock _Nonnull);
	delegate void MASUserAuthCredentialsBlock (MASAuthCredentialsBlock arg0);

	// typedef void (^MASOTPGenerationBlock)(NSArray * _Nonnull, BOOL, MASCompletionErrorBlock _Nullable);
	delegate void MASOTPGenerationBlock (NSObject[] arg0, bool arg1, [NullAllowed] MASCompletionErrorBlock arg2);

	// typedef void (^MASOTPFetchCredentialsBlock)(NSString * _Nonnull, BOOL, MASCompletionErrorBlock _Nullable);
	delegate void MASOTPFetchCredentialsBlock (string arg0, bool arg1, [NullAllowed] MASCompletionErrorBlock arg2);

	// typedef void (^MASOTPChannelSelectionBlock)(NSArray * _Nonnull, MASOTPGenerationBlock _Nonnull);
	delegate void MASOTPChannelSelectionBlock (NSObject[] arg0, MASOTPGenerationBlock arg1);

	// typedef void (^MASOTPCredentialsBlock)(MASOTPFetchCredentialsBlock _Nonnull, NSError * _Nullable);
	delegate void MASOTPCredentialsBlock (MASOTPFetchCredentialsBlock arg0, [NullAllowed] NSError arg1);
	...
	delegate void MASNetworkReachabilityStatusBlock (MASNetworkReachabilityStatus arg0);
...
*/[Protocol]
	...
	{
		// @required -(MASMultiFactorHandler * _Nullable)getMultiFactorHandler:(MASRequest * _Nonnull)request response:(NSURLResponse * _Nonnull)response;
		[Abstract]
		[Export ("getMultiFactorHandler:response:")]
		[return: NullAllowed]
		MASMultiFactorHandler GetMultiFactorHandler (MASRequest request, NSUrlResponse response);

		// @required -(void)onMultiFactorAuthenticationRequest:(MASRequest * _Nonnull)request response:(NSURLResponse * _Nonnull)response handler:(MASMultiFactorHandler * _Nonnull)handler;
		[Abstract]
		[Export ("onMultiFactorAuthenticationRequest:response:handler:")]
		void OnMultiFactorAuthenticationRequest (MASRequest request, NSUrlResponse response, MASMultiFactorHandler handler);
	}
...
*/[Protocol]
	...
	[BaseType (typeof(NSObject))]
	interface MASSafariBrowserBasedAuthenticationConfiguration : IMASBrowserBasedAuthenticationConfigurationInterface
	{
	}
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface MASWebSessionBrowserBasedAuthenticationConfiguration : IMASBrowserBasedAuthenticationConfigurationInterface
	{
	...
	interface MAS
	{
		...
		[Static]
		[Export ("setKeychainSharingGroup:")]
		void SetKeychainSharingGroup (string keychainSharingGroup);
		...
		// +(void)invoke:(MASRequest * _Nonnull)request completion:(MASResponseObjectErrorBlock _Nullable)completion;
		[Static]
		[Export ("invoke:completion:")]
		void Invoke (MASRequest request, [NullAllowed] MASResponseObjectErrorBlock completion);

		// +(void)invoke:(MASRequest * _Nonnull)request taskBlock:(MASDataTaskBlock _Nullable)taskBlock completion:(MASResponseObjectErrorBlock _Nullable)completion;
		[Static]
		[Export ("invoke:taskBlock:completion:")]
		void Invoke (MASRequest request, [NullAllowed] MASDataTaskBlock taskBlock, [NullAllowed] MASResponseObjectErrorBlock completion);
		...
		// +(void)postMultiPartForm:(MASRequest * _Nonnull)request constructingBodyWithBlock:(MASMultiPartFormDataBlock _Nonnull)formDataBlock progress:(MASFileRequestProgressBlock _Nullable)progressBlock taskBlock:(MASDataTaskBlock _Nullable)taskBlock completion:(MASResponseObjectErrorBlock _Nullable)completion;
		[Static]
		[Export ("postMultiPartForm:constructingBodyWithBlock:progress:taskBlock:completion:")]
		void PostMultiPartForm (MASRequest request, MASMultiPartFormDataBlock formDataBlock, [NullAllowed] MASFileRequestProgressBlock progressBlock, [NullAllowed] MASDataTaskBlock taskBlock, [NullAllowed] MASResponseObjectErrorBlock completion);

		// +(BOOL)cancelRequest:(MASDataTask * _Nonnull)task error:(NSError * _Nullable * _Nullable)error;
		[Static]
		[Export ("cancelRequest:error:")]
		bool CancelRequest (MASDataTask task, [NullAllowed] out NSError error);
	...
	interface MASMQTTClient
	{
		...
		// @property (assign, nonatomic) BOOL validateCertificateChain;
		[Export ("validateCertificateChain")]
		bool ValidateCertificateChain { get; set; }

		// @property (assign, nonatomic) BOOL validateDomainName;
		[Export ("validateDomainName")]
		bool ValidateDomainName { get; set; }

		// @property (assign, nonatomic) MASMQTTSSLPinningMode pinningMode;
		[Export ("pinningMode", ArgumentSemantic.Assign)]
		MASMQTTSSLPinningMode PinningMode { get; set; }

		// @property (nonatomic, strong) NSArray * _Nonnull pinnedCertificates;
		[Export ("pinnedCertificates", ArgumentSemantic.Strong)]
		[Verify (StronglyTypedNSArray)]
		NSObject[] PinnedCertificates { get; set; }

		// @property (nonatomic, strong) NSArray * _Nonnull clientCertificates;
		[Export ("clientCertificates", ArgumentSemantic.Strong)]
		[Verify (StronglyTypedNSArray)]
		NSObject[] ClientCertificates { get; set; }
		...
		// -(void)connectWithHost:(NSString * _Nonnull)hostName withPort:(int)port enableTLS:(BOOL)tls usingSSLCACert:(NSString * _Nonnull)certFile completionHandler:(void (^ _Nonnull)(MQTTConnectionReturnCode))completionHandler __attribute__((deprecated("This method has been deprecated as in MAG 1.7; use [MASMQTTClient connectWithHost:withPort:enableTLS:completionHandler:] along with MASSecurityConfiguration.")));
		...
		// -(void)setMessageRetry:(NSUInteger)seconds __attribute__((deprecated("This method has been deprecated as in MAG 1.7")));
		[Export ("setMessageRetry:")]
		void SetMessageRetry (nuint seconds);

		// +(NSString * _Nonnull)version __attribute__((deprecated("This static method has been deprecated as in MAG 1.7")));
		[Static]
		[Export ("version")]
		[Verify (MethodToProperty)]
		string Version { get; }
	...
	interface MASApplication
	{
		...
		void LoadWebApp (WKWebView webView, [NullAllowed] MASCompletionErrorBlock completion);
	}
...
*/[Protocol]
	...
	interface MASAuthenticationProviders
	{
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] Providers { get; }

		// @property (readonly, copy, nonatomic) NSString * _Nullable idp;
		[NullAllowed, Export ("idp")]
		string Idp { get; }

		// @property (readonly, copy, nonatomic) NSString * _Nullable PKCEstate;
	...
	interface MASAuthorizationResponse
	{
		...
		// -(BOOL)handleAuthorizationResponseURL:(NSURL * _Nonnull)url;
		[Export ("handleAuthorizationResponseURL:")]
	...
	interface MASConfiguration
	{
		...
		// @property (readonly, copy, nonatomic) NSArray * _Nullable trustedCertPinnedPublicKeyHashes;
		[NullAllowed, Export ("trustedCertPinnedPublicKeyHashes", ArgumentSemantic.Copy)]
		[Verify (StronglyTypedNSArray)]
		NSObject[] TrustedCertPinnedPublicKeyHashes { get; }
		...
		// +(BOOL)setNetworkConfiguration:(MASNetworkConfiguration * _Nonnull)networkConfiguration error:(NSError * _Nullable * _Nullable)error;
		[Static]
		[Export ("setNetworkConfiguration:error:")]
		bool SetNetworkConfiguration (MASNetworkConfiguration networkConfiguration, [NullAllowed] out NSError error);

		// +(void)removeNetworkConfigurationForDomain:(NSURL * _Nonnull)domain;
		[Static]
		[Export ("removeNetworkConfigurationForDomain:")]
		void RemoveNetworkConfigurationForDomain (NSUrl domain);

		// +(NSArray * _Nullable)networkConfigurations;
		[Static]
		[NullAllowed, Export ("networkConfigurations")]
		[Verify (MethodToProperty), Verify (StronglyTypedNSArray)]
		NSObject[] NetworkConfigurations { get; }

		// +(MASNetworkConfiguration * _Nullable)networkConfigurationForDomain:(NSURL * _Nonnull)domain;
		[Static]
		[Export ("networkConfigurationForDomain:")]
		[return: NullAllowed]
		...
		[Verify (MethodToProperty), Verify (StronglyTypedNSArray)]
		NSObject[] SecurityConfigurations { get; }
		...
		// @property (readonly, copy, nonatomic) NSString * _Nullable deviceMetadataEndpointPath;
		[NullAllowed, Export ("deviceMetadataEndpointPath")]
		string DeviceMetadataEndpointPath { get; }
	...
	interface MASUser
	{
		...
		// -(void)logoutWithCompletion:(MASCompletionErrorBlock _Nullable)completion __attribute__((deprecated("[[MASUser currentUser] logoutWithCompletion:] is deprecated.  Use [[MASUser currentUser] logout:completion:] instead.")));
	...
	{
		// @property (readonly) NSString * _Nonnull taskID;
		[Export ("taskID")]
		string TaskID { get; }
	}
	...
	{
		// @property (readonly, nonatomic, strong) NSString * _Nonnull credentialsType;
		[Export ("credentialsType", ArgumentSemantic.Strong)]
		string CredentialsType { get; }

		// @property (readonly, nonatomic, strong) NSString * _Nonnull csrUsername;
		[Export ("csrUsername", ArgumentSemantic.Strong)]
		string CsrUsername { get; }

		// @property (readonly, nonatomic, strong) NSString * _Nonnull registerEndpoint;
		[Export ("registerEndpoint", ArgumentSemantic.Strong)]
		string RegisterEndpoint { get; }

		// @property (readonly, nonatomic, strong) NSString * _Nonnull tokenEndpoint;
		...
		// @property (readonly, assign, nonatomic) BOOL isReusable;
		[Export ("isReusable")]
		bool IsReusable { get; }
		...
		[NullAllowed, Export ("getHeaders")]
		[Verify (MethodToProperty)]
		NSDictionary Headers { get; }

		// -(NSDictionary * _Nullable)getParameters;
		[NullAllowed, Export ("getParameters")]
		[Verify (MethodToProperty)]
	...
	interface MASMultiFactorHandler
	{
		...
		void ProceedWithHeaders ([NullAllowed] NSDictionary headers);

		// -(void)cancelWithError:(NSError * _Nullable)error;
		[Export ("cancelWithError:")]
		void CancelWithError ([NullAllowed] NSError error);
